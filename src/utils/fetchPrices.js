...
export const BASELINE_PRICES = [
  { crop: CROP_META['Maize'].name, unit: CROP_META['Maize'].unit, price: '₹5,000', change: '+₹10', trend: 'up', market: CROP_META['Maize'].market, img: CROP_META['Maize'].img, districts: CROP_META['Maize'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Bengal gram'].name, unit: CROP_META['Bengal gram'].unit, price: '₹5,000', change: '+₹10', trend: 'up', market: CROP_META['Bengal gram'].market, img: CROP_META['Bengal gram'].img, districts: CROP_META['Bengal gram'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Groundnut'].name, unit: CROP_META['Groundnut'].unit, price: '₹5,600', change: '+₹10', trend: 'up', market: CROP_META['Groundnut'].market, img: CROP_META['Groundnut'].img, districts: CROP_META['Groundnut'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Sunflower'].name, unit: CROP_META['Sunflower'].unit, price: '₹6,500', change: '+₹10', trend: 'up', market: CROP_META['Sunflower'].market, img: CROP_META['Sunflower'].img, districts: CROP_META['Sunflower'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Jowar'].name, unit: CROP_META['Jowar'].unit, price: '₹3,500', change: '+₹10', trend: 'up', market: CROP_META['Jowar'].market, img: CROP_META['Jowar'].img, districts: CROP_META['Jowar'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Bajra'].name, unit: CROP_META['Bajra'].unit, price: '₹2,800', change: '+₹10', trend: 'up', market: CROP_META['Bajra'].market, img: CROP_META['Bajra'].img, districts: CROP_META['Bajra'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Wheat'].name, unit: CROP_META['Wheat'].unit, price: '₹2,800', change: '+₹10', trend: 'up', market: CROP_META['Wheat'].market, img: CROP_META['Wheat'].img, districts: CROP_META['Wheat'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Tur'].name, unit: CROP_META['Tur'].unit, price: '₹5,500', change: '+₹10', trend: 'up', market: CROP_META['Tur'].market, img: CROP_META['Tur'].img, districts: CROP_META['Tur'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Chilli'].name, unit: CROP_META['Chilli'].unit, price: '₹23,000', change: '+₹10', trend: 'up', market: CROP_META['Chilli'].market, img: CROP_META['Chilli'].img, districts: CROP_META['Chilli'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Cotton'].name, unit: CROP_META['Cotton'].unit, price: '₹7,000', change: '+₹10', trend: 'up', market: CROP_META['Cotton'].market, img: CROP_META['Cotton'].img, districts: CROP_META['Cotton'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Paddy'].name, unit: CROP_META['Paddy'].unit, price: '₹3,500', change: '+₹10', trend: 'up', market: CROP_META['Paddy'].market, img: CROP_META['Paddy'].img, districts: CROP_META['Paddy'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Sugarcane'].name, unit: CROP_META['Sugarcane'].unit, price: '₹350', change: '+₹10', trend: 'up', market: CROP_META['Sugarcane'].market, img: CROP_META['Sugarcane'].img, districts: CROP_META['Sugarcane'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Soybean'].name, unit: CROP_META['Soybean'].unit, price: '₹7,000', change: '+₹10', trend: 'up', market: CROP_META['Soybean'].market, img: CROP_META['Soybean'].img, districts: CROP_META['Soybean'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Ragi'].name, unit: CROP_META['Ragi'].unit, price: '₹4,000', change: '+₹10', trend: 'up', market: CROP_META['Ragi'].market, img: CROP_META['Ragi'].img, districts: CROP_META['Ragi'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Tomato'].name, unit: CROP_META['Tomato'].unit, price: '₹2,500', change: '+₹10', trend: 'up', market: CROP_META['Tomato'].market, img: CROP_META['Tomato'].img, districts: CROP_META['Tomato'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Potato'].name, unit: CROP_META['Potato'].unit, price: '₹1,500', change: '+₹10', trend: 'up', market: CROP_META['Potato'].market, img: CROP_META['Potato'].img, districts: CROP_META['Potato'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Onion'].name, unit: CROP_META['Onion'].unit, price: '₹1,800', change: '+₹10', trend: 'up', market: CROP_META['Onion'].market, img: CROP_META['Onion'].img, districts: CROP_META['Onion'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Beans'].name, unit: CROP_META['Beans'].unit, price: '₹3,600', change: '+₹10', trend: 'up', market: CROP_META['Beans'].market, img: CROP_META['Beans'].img, districts: CROP_META['Beans'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Mulberry'].name, unit: CROP_META['Mulberry'].unit, price: '₹6,000', change: '+₹10', trend: 'up', market: CROP_META['Mulberry'].market, img: CROP_META['Mulberry'].img, districts: CROP_META['Mulberry'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Finger millet'].name, unit: CROP_META['Finger millet'].unit, price: '₹4,000', change: '+₹10', trend: 'up', market: CROP_META['Finger millet'].market, img: CROP_META['Finger millet'].img, districts: CROP_META['Finger millet'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Rice'].name, unit: CROP_META['Rice'].unit, price: '₹5,333', change: '+₹10', trend: 'up', market: CROP_META['Rice'].market, img: CROP_META['Rice'].img, districts: CROP_META['Rice'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Green gram'].name, unit: CROP_META['Green gram'].unit, price: '₹10,750', change: '+₹10', trend: 'up', market: CROP_META['Green gram'].market, img: CROP_META['Green gram'].img, districts: CROP_META['Green gram'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Black gram'].name, unit: CROP_META['Black gram'].unit, price: '₹5,000', change: '+₹10', trend: 'up', market: CROP_META['Black gram'].market, img: CROP_META['Black gram'].img, districts: CROP_META['Black gram'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Dry chilli'].name, unit: CROP_META['Dry chilli'].unit, price: '₹23,000', change: '+₹10', trend: 'up', market: CROP_META['Dry chilli'].market, img: CROP_META['Dry chilli'].img, districts: CROP_META['Dry chilli'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Turmeric'].name, unit: CROP_META['Turmeric'].unit, price: '₹8,000', change: '+₹10', trend: 'up', market: CROP_META['Turmeric'].market, img: CROP_META['Turmeric'].img, districts: CROP_META['Turmeric'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Tamarind'].name, unit: CROP_META['Tamarind'].unit, price: '₹12,500', change: '+₹10', trend: 'up', market: CROP_META['Tamarind'].market, img: CROP_META['Tamarind'].img, districts: CROP_META['Tamarind'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Sesame'].name, unit: CROP_META['Sesame'].unit, price: '₹15,500', change: '+₹10', trend: 'up', market: CROP_META['Sesame'].market, img: CROP_META['Sesame'].img, districts: CROP_META['Sesame'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Coconut'].name, unit: CROP_META['Coconut'].unit, price: '₹3,500', change: '+₹10', trend: 'up', market: CROP_META['Coconut'].market, img: CROP_META['Coconut'].img, districts: CROP_META['Coconut'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Arecanut'].name, unit: CROP_META['Arecanut'].unit, price: '₹55,400', change: '+₹650', trend: 'up', market: 'Shivamogga APMC (Rashi Supari)', img: CROP_META['Arecanut'].img, districts: CROP_META['Arecanut'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Green chilli'].name, unit: CROP_META['Green chilli'].unit, price: '₹5,000', change: '+₹10', trend: 'up', market: CROP_META['Green chilli'].market, img: CROP_META['Green chilli'].img, districts: CROP_META['Green chilli'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Lime'].name, unit: CROP_META['Lime'].unit, price: '₹4,500', change: '+₹10', trend: 'up', market: CROP_META['Lime'].market, img: CROP_META['Lime'].img, districts: CROP_META['Lime'].districts , type: 'crop', type: 'fruit' },
  { crop: CROP_META['Coffee'].name, unit: CROP_META['Coffee'].unit, price: '₹22,000', change: '+₹10', trend: 'up', market: CROP_META['Coffee'].market, img: CROP_META['Coffee'].img, districts: CROP_META['Coffee'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Castor seed'].name, unit: CROP_META['Castor seed'].unit, price: '₹5,400', change: '+₹10', trend: 'up', market: CROP_META['Castor seed'].market, img: CROP_META['Castor seed'].img, districts: CROP_META['Castor seed'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Horse gram'].name, unit: CROP_META['Horse gram'].unit, price: '₹5,000', change: '+₹10', trend: 'up', market: CROP_META['Horse gram'].market, img: CROP_META['Horse gram'].img, districts: CROP_META['Horse gram'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Cashew'].name, unit: CROP_META['Cashew'].unit, price: '₹12,000', change: '+₹10', trend: 'up', market: CROP_META['Cashew'].market, img: CROP_META['Cashew'].img, districts: CROP_META['Cashew'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Black pepper'].name, unit: CROP_META['Black pepper'].unit, price: '₹65,000', change: '+₹10', trend: 'up', market: CROP_META['Black pepper'].market, img: CROP_META['Black pepper'].img, districts: CROP_META['Black pepper'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Banana'].name, unit: CROP_META['Banana'].unit, price: '₹2,500', change: '+₹10', trend: 'up', market: CROP_META['Banana'].market, img: CROP_META['Banana'].img, districts: CROP_META['Banana'].districts , type: 'crop', type: 'fruit' },
  { crop: CROP_META['Ginger'].name, unit: CROP_META['Ginger'].unit, price: '₹7,800', change: '+₹10', trend: 'up', market: CROP_META['Ginger'].market, img: CROP_META['Ginger'].img, districts: CROP_META['Ginger'].districts , type: 'crop', type: 'vegetable' },
  { crop: CROP_META['Cocoa'].name, unit: CROP_META['Cocoa'].unit, price: '₹18,000', change: '+₹10', trend: 'up', market: CROP_META['Cocoa'].market, img: CROP_META['Cocoa'].img, districts: CROP_META['Cocoa'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Rubber'].name, unit: CROP_META['Rubber'].unit, price: '₹18,000', change: '+₹10', trend: 'up', market: CROP_META['Rubber'].market, img: CROP_META['Rubber'].img, districts: CROP_META['Rubber'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Cardamom'].name, unit: CROP_META['Cardamom'].unit, price: '₹180,000', change: '+₹10', trend: 'up', market: CROP_META['Cardamom'].market, img: CROP_META['Cardamom'].img, districts: CROP_META['Cardamom'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Mango'].name, unit: CROP_META['Mango'].unit, price: '₹5,000', change: '+₹10', trend: 'up', market: CROP_META['Mango'].market, img: CROP_META['Mango'].img, districts: CROP_META['Mango'].districts , type: 'crop', type: 'fruit' },
  { crop: CROP_META['Tobacco'].name, unit: CROP_META['Tobacco'].unit, price: '₹12,000', change: '+₹10', trend: 'up', market: CROP_META['Tobacco'].market, img: CROP_META['Tobacco'].img, districts: CROP_META['Tobacco'].districts , type: 'crop', type: 'crop' },
  { crop: CROP_META['Pineapple'].name, unit: CROP_META['Pineapple'].unit, price: '₹3,500', change: '+₹10', trend: 'up', market: CROP_META['Pineapple'].market, img: CROP_META['Pineapple'].img, districts: CROP_META['Pineapple'].districts , type: 'crop', type: 'fruit' }
  // NEW VEGETABLES
