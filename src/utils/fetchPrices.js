...
const CROP_META = {
  ...
  'Sugarcane': { name: 'Sugarcane (ಕಬ್ಬು)', unit: 'per quintal', img: '/crops/Sugarcane.jpg', market: 'Belagavi APMC', districts: ["Belagavi","Chamarajanagar","Davanagere","Mandya","Mysuru","Shivamogga","Vijayanagara"], type: 'crop' },
  ...
  'Tomato': { name: 'Tomato (ಟೊಮೇಟೊ)', unit: 'per quintal', img: '/crops/Tomato.jpg', market: 'Bengaluru Rural APMC', districts: ["Bengaluru Rural","Chamarajanagar","Chikkaballapur","Chikkamagaluru","Hassan","Kolar","Mandya","Ramanagara","Tumakuru"], type: 'crop' },
  'Potato': { name: 'Potato (ಆಲೂಗಡ್ಡೆ)', unit: 'per quintal', img: '/crops/Potato.jpg', market: 'Bengaluru Rural APMC', districts: ["Bengaluru Rural","Chikkaballapur","Chikkamagaluru","Hassan","Kolar"], type: 'crop' },
  'Onion': { name: 'Onion (ಈರುಳ್ಳಿ)', unit: 'per quintal', img: '/crops/Onion.jpg', market: 'Bengaluru Rural APMC', districts: ["Bengaluru Rural","Chikkaballapur","Chitradurga","Kolar","Tumakuru"], type: 'crop' },
  'Beans': { name: 'Beans (ಬೀನ್ಸ್)', unit: 'per quintal', img: '/crops/Beans.jpg', market: 'Hoskote APMC', districts: ["Bengaluru Rural","Chikkaballapur","Chikkamagaluru","Kolar"], type: 'crop' },
  ...
  'Banana': { name: 'Banana (ಬಾಳೆಹಣ್ಣು)', unit: 'per quintal', img: '/crops/Banana.jpg', market: 'Dakshina Kannada APMC', districts: ["Dakshina Kannada","Kodagu","Mandya","Mysuru","Ramanagara","Shivamogga","Udupi","Uttara Kannada"], type: 'crop' },
  ...
  'Cardamom': { name: 'Cardamom (ಏಲಕ್ಕಿ)', unit: 'per quintal', img: '/crops/Cardamom.jpg', market: 'Kodagu APMC', districts: ["Kodagu","Uttara Kannada"], type: 'crop' },
  'Mango': { name: 'Mango (ಮಾವಿನಹಣ್ಣು)', unit: 'per quintal', img: '/crops/Mango.jpg', market: 'Kolar APMC', districts: ["Kolar","Ramanagara","Uttara Kannada"], type: 'crop' },
  'Tobacco': { name: 'Tobacco (ತಂಬಾಕು)', unit: 'per quintal', img: '/crops/Tobacco.jpg', market: 'Mysuru APMC', districts: ["Mysuru"], type: 'crop' },
  'Pineapple': { name: 'Pineapple (ಅನಾನಸ್)', unit: 'per quintal', img: '/crops/Pineapple.jpg', market: 'Udupi APMC', districts: ["Udupi"], type: 'crop' },
};
...
export const BASELINE_PRICES = [
  ...
  // NEW VEGETABLES
  { crop: 'Cabbage (ಎಲೆಕೋಸು)', unit: 'per quintal', price: '₹2,200', change: '+₹50', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Cabbage.jpg', districts: [], type: 'vegetable' },
  { crop: 'Cauliflower (ಹೂಕೋಸು)', unit: 'per quintal', price: '₹2,800', change: '+₹80', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Cauliflower.jpg', districts: [], type: 'vegetable' },
  { crop: 'Brinjal (ಬದನೆಕಾಯಿ)', unit: 'per quintal', price: '₹2,200', change: '+₹40', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Brinjal.jpg', districts: [], type: 'vegetable' },
  { crop: 'Carrot (ಕ್ಯಾರೆಟ್)', unit: 'per quintal', price: '₹3,500', change: '+₹60', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Carrot.jpg', districts: [], type: 'vegetable' },
  { crop: 'Cucumber (ಸೌತೆಕಾಯಿ)', unit: 'per quintal', price: '₹1,500', change: '-₹30', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Cucumber.jpg', districts: [], type: 'vegetable' },
  { crop: 'Capsicum (ದಪ್ಪ ಮೆಣಸಿನಕಾಯಿ)', unit: 'per quintal', price: '₹4,800', change: '+₹100', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Capsicum.jpg', districts: [], type: 'vegetable' },
  { crop: 'Okra (ಬೆಂಡೆಕಾಯಿ)', unit: 'per quintal', price: '₹2,800', change: '+₹50', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Okra.jpg', districts: [], type: 'vegetable' },
  { crop: 'Ridge Gourd (ಹೀರೆಕಾಯಿ)', unit: 'per quintal', price: '₹2,500', change: '+₹0', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Ridge_Gourd.jpg', districts: [], type: 'vegetable' },
  { crop: 'Bitter Gourd (ಹಾಗಲಕಾಯಿ)', unit: 'per quintal', price: '₹3,200', change: '+₹60', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Bitter_Gourd.jpg', districts: [], type: 'vegetable' },
  { crop: 'Bottle Gourd (ಸೋರೆಕಾಯಿ)', unit: 'per quintal', price: '₹1,800', change: '-₹20', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Bottle_Gourd.jpg', districts: [], type: 'vegetable' },
  { crop: 'Radish (ಮೂಲಂಗಿ)', unit: 'per quintal', price: '₹1,200', change: '+₹20', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Radish.jpg', districts: [], type: 'vegetable' },
  { crop: 'Garlic (ಬೆಳ್ಳುಳ್ಳಿ)', unit: 'per quintal', price: '₹12,000', change: '+₹200', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Garlic.jpg', districts: [], type: 'vegetable' },
  
  // NEW FRUITS
  { crop: 'Apple (ಸೇಬು)', unit: 'per quintal', price: '₹9,500', change: '+₹150', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Apple.jpg', districts: [], type: 'fruit' },
  { crop: 'Pomegranate (ದಾಳಿಂಬೆ)', unit: 'per quintal', price: '₹11,000', change: '+₹200', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Pomegranate.jpg', districts: [], type: 'fruit' },
  { crop: 'Grapes (ದ್ರಾಕ್ಷಿ)', unit: 'per quintal', price: '₹6,500', change: '-₹100', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Grapes.jpg', districts: [], type: 'fruit' },
  { crop: 'Orange (ಕಿತ್ತಳೆ)', unit: 'per quintal', price: '₹4,500', change: '+₹50', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Orange.jpg', districts: [], type: 'fruit' },
  { crop: 'Sweet Lime (ಮೂಸಂಬಿ)', unit: 'per quintal', price: '₹4,000', change: '+₹40', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Sweet_Lime.jpg', districts: [], type: 'fruit' },
  { crop: 'Watermelon (ಕಲ್ಲಂಗಡಿ)', unit: 'per quintal', price: '₹1,400', change: '-₹30', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Watermelon.jpg', districts: [], type: 'fruit' },
  { crop: 'Papaya (ಪಪ್ಪಾಯಿ)', unit: 'per quintal', price: '₹2,200', change: '+₹0', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Papaya.jpg', districts: [], type: 'fruit' },
  { crop: 'Guava (ಸೀಬೆಕಾಯಿ)', unit: 'per quintal', price: '₹3,500', change: '+₹80', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Guava.jpg', districts: [], type: 'fruit' },
  { crop: 'Sapota (ಸಪೋಟ)', unit: 'per quintal', price: '₹3,800', change: '+₹50', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Sapota.jpg', districts: [], type: 'fruit' },
  { crop: 'Beetroot (ಬೀಟ್ರೂಟ್)', unit: 'per quintal', price: '₹2,200', change: '+₹40', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Beetroot.jpg', districts: [], type: 'vegetable' },
  { crop: 'Drumstick (ನುಗ್ಗೆಕಾಯಿ)', unit: 'per quintal', price: '₹3,800', change: '+₹100', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Drumstick.jpg', districts: [], type: 'vegetable' },
  { crop: 'Spinach (ಪಾಲಕ್)', unit: 'per quintal', price: '₹1,800', change: '-₹30', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Spinach.jpg', districts: [], type: 'vegetable' },
  { crop: 'Sweet Potato (ಗೆಣಸು)', unit: 'per quintal', price: '₹2,000', change: '+₹40', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Sweet_Potato.jpg', districts: [], type: 'vegetable' },
  { crop: 'Pumpkin (ಕುಂಬಳಕಾಯಿ)', unit: 'per quintal', price: '₹1,200', change: '-₹50', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Pumpkin.jpg', districts: [], type: 'vegetable' },
  { crop: 'Jackfruit (ಹಲಸಿನ ಹಣ್ಣು)', unit: 'per quintal', price: '₹3,500', change: '+₹100', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Jackfruit.jpg', districts: [], type: 'fruit' },
  { crop: 'Custard Apple (ಸೀತಾಫಲ)', unit: 'per quintal', price: '₹7,500', change: '+₹150', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Custard_Apple.jpg', districts: [], type: 'fruit' },
  { crop: 'Fig (ಅಂಜೂರ)', unit: 'per quintal', price: '₹9,000', change: '+₹100', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Fig.jpg', districts: [], type: 'fruit' },
  { crop: 'Strawberry (ಸ್ಟ್ರಾಬೆರಿ)', unit: 'per quintal', price: '₹16,000', change: '-₹200', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Strawberry.jpg', districts: [], type: 'fruit' },
  { crop: 'Muskmelon (ಖರಬೂಜ)', unit: 'per quintal', price: '₹2,000', change: '+₹40', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Muskmelon.jpg', districts: [], type: 'fruit' },
];
