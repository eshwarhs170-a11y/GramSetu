...
export const BASELINE_PRICES = [
  ...
  // NEW VEGETABLES
  { crop: 'Cabbage (ಎಲೆಕೋಸು)', unit: 'per kg', price: '₹40', change: '+₹2', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Cabbage.jpg', districts: [], type: 'vegetable' },
  { crop: 'Cauliflower (ಹೂಕೋಸು)', unit: 'per kg', price: '₹50', change: '+₹5', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Cauliflower.jpg', districts: [], type: 'vegetable' },
  { crop: 'Brinjal (ಬದನೆಕಾಯಿ)', unit: 'per kg', price: '₹35', change: '+₹1', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Brinjal.jpg', districts: [], type: 'vegetable' },
  { crop: 'Carrot (ಕ್ಯಾರೆಟ್)', unit: 'per kg', price: '₹60', change: '+₹3', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Carrot.jpg', districts: [], type: 'vegetable' },
  { crop: 'Cucumber (ಸೌತೆಕಾಯಿ)', unit: 'per kg', price: '₹25', change: '-₹2', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Cucumber.jpg', districts: [], type: 'vegetable' },
  { crop: 'Capsicum (ದಪ್ಪ ಮೆಣಸಿನಕಾಯಿ)', unit: 'per kg', price: '₹80', change: '+₹4', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Capsicum.jpg', districts: [], type: 'vegetable' },
  { crop: 'Okra (ಬೆಂಡೆಕಾಯಿ)', unit: 'per kg', price: '₹45', change: '+₹2', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Okra.jpg', districts: [], type: 'vegetable' },
  { crop: 'Ridge Gourd (ಹೀರೆಕಾಯಿ)', unit: 'per kg', price: '₹40', change: '+₹0', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Ridge_Gourd.jpg', districts: [], type: 'vegetable' },
  { crop: 'Bitter Gourd (ಹಾಗಲಕಾಯಿ)', unit: 'per kg', price: '₹55', change: '+₹3', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Bitter_Gourd.jpg', districts: [], type: 'vegetable' },
  { crop: 'Bottle Gourd (ಸೋರೆಕಾಯಿ)', unit: 'per kg', price: '₹30', change: '-₹1', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Bottle_Gourd.jpg', districts: [], type: 'vegetable' },
  { crop: 'Radish (ಮೂಲಂಗಿ)', unit: 'per kg', price: '₹20', change: '+₹1', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Radish.jpg', districts: [], type: 'vegetable' },
  { crop: 'Garlic (ಬೆಳ್ಳುಳ್ಳಿ)', unit: 'per kg', price: '₹120', change: '+₹10', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Garlic.jpg', districts: [], type: 'vegetable' },
  
  // NEW FRUITS
  { crop: 'Apple (ಸೇಬು)', unit: 'per kg', price: '₹150', change: '+₹5', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Apple.jpg', districts: [], type: 'fruit' },
  { crop: 'Pomegranate (ದಾಳಿಂಬೆ)', unit: 'per kg', price: '₹180', change: '+₹10', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Pomegranate.jpg', districts: [], type: 'fruit' },
  { crop: 'Grapes (ದ್ರಾಕ್ಷಿ)', unit: 'per kg', price: '₹100', change: '-₹5', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Grapes.jpg', districts: [], type: 'fruit' },
  { crop: 'Orange (ಕಿತ್ತಳೆ)', unit: 'per kg', price: '₹80', change: '+₹2', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Orange.jpg', districts: [], type: 'fruit' },
  { crop: 'Sweet Lime (ಮೂಸಂಬಿ)', unit: 'per kg', price: '₹70', change: '+₹1', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Sweet_Lime.jpg', districts: [], type: 'fruit' },
  { crop: 'Watermelon (ಕಲ್ಲಂಗಡಿ)', unit: 'per kg', price: '₹60', change: '-₹2', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Watermelon.jpg', districts: [], type: 'fruit' },
  { crop: 'Papaya (ಪಪ್ಪಾಯಿ)', unit: 'per kg', price: '₹50', change: '+₹0', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Papaya.jpg', districts: [], type: 'fruit' },
  { crop: 'Guava (ಸೀಬೆಕಾಯಿ)', unit: 'per kg', price: '₹60', change: '+₹4', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Guava.jpg', districts: [], type: 'fruit' },
  { crop: 'Sapota (ಸಪೋಟ)', unit: 'per kg', price: '₹70', change: '+₹2', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Sapota.jpg', districts: [], type: 'fruit' },
  { crop: 'Beetroot (ಬೀಟ್ರೂಟ್)', unit: 'per kg', price: '₹40', change: '+₹2', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Beetroot.jpg', districts: [], type: 'vegetable' },
  { crop: 'Drumstick (ನುಗ್ಗೆಕಾಯಿ)', unit: 'per kg', price: '₹60', change: '+₹5', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Drumstick.jpg', districts: [], type: 'vegetable' },
  { crop: 'Spinach (ಪಾಲಕ್)', unit: 'per kg', price: '₹30', change: '-₹1', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Spinach.jpg', districts: [], type: 'vegetable' },
  { crop: 'Sweet Potato (ಗೆಣಸು)', unit: 'per kg', price: '₹35', change: '+₹2', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Sweet_Potato.jpg', districts: [], type: 'vegetable' },
  { crop: 'Pumpkin (ಕುಂಬಳಕಾಯಿ)', unit: 'per kg', price: '₹25', change: '-₹3', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Pumpkin.jpg', districts: [], type: 'vegetable' },
  { crop: 'Jackfruit (ಹಲಸಿನ ಹಣ್ಣು)', unit: 'per kg', price: '₹80', change: '+₹5', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Jackfruit.jpg', districts: [], type: 'fruit' },
  { crop: 'Custard Apple (ಸೀತಾಫಲ)', unit: 'per kg', price: '₹120', change: '+₹10', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Custard_Apple.jpg', districts: [], type: 'fruit' },
  { crop: 'Fig (ಅಂಜೂರ)', unit: 'per kg', price: '₹150', change: '+₹5', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Fig.jpg', districts: [], type: 'fruit' },
  { crop: 'Strawberry (ಸ್ಟ್ರಾಬೆರಿ)', unit: 'per kg', price: '₹200', change: '-₹10', trend: 'down', market: 'Bengaluru APMC', img: '/crops/Strawberry.jpg', districts: [], type: 'fruit' },
  { crop: 'Muskmelon (ಖರಬೂಜ)', unit: 'per kg', price: '₹40', change: '+₹2', trend: 'up', market: 'Bengaluru APMC', img: '/crops/Muskmelon.jpg', districts: [], type: 'fruit' },
];
