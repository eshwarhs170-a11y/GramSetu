    ...
    diseases: [
      {
        ...
        products: [
          { name: 'Metalaxyl 8% + Mancozeb 64% WP', type: 'chemical', brand: 'Ridomil Gold (Syngenta)', price: '₹480 – ₹680 / 500g', query: 'Metalaxyl Mancozeb 72 WP' },
          { name: 'Dimethomorph 50 WP', type: 'chemical', brand: 'Acrobat (BASF)', price: '₹550 – ₹750 / 100g', query: 'Dimethomorph 50 WP Acrobat' },
          { name: 'Calcium Nitrate 15.5% N + 18.8% Ca', type: 'fertilizer', brand: 'YaraLiva / IFFCO', price: '₹850 – ₹1,200 / 25kg', query: 'Calcium Nitrate fertilizer 25kg' }
        ]
      },
      {
        ...
        products: [
          { name: 'Chlorothalonil 75 WP', type: 'chemical', brand: 'Kavach (Syngenta)', price: '₹420 – ₹580 / 500g', query: 'Chlorothalonil 75 WP Kavach' },
      ...
      },
      {
        ...
        products: [
          { name: 'Diafenthiuron 50 WP', type: 'chemical', brand: 'Pegasus', price: '₹620 – ₹880 / 250g', query: 'Diafenthiuron 50 WP Pegasus' },
          { name: 'Cyantraniliprole 10.26 OD', type: 'chemical', brand: 'Benevia (FMC)', price: '₹1,250 – ₹1,650 / 180mL', query: 'Cyantraniliprole Benevia FMC' },
          { name: 'Yellow Sticky Traps for Whitefly', type: 'organic', brand: 'Agri Sticky Pads', price: '₹220 – ₹320 / pack of 10', query: 'Yellow sticky traps agriculture' }
        ]
      },
      {
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Flubendiamide 39.35 SC', type: 'chemical', brand: 'Fame (Bayer)', price: '₹750 – ₹980 / 100mL', query: 'Flubendiamide 39.35 SC Fame' },
          { name: 'Helilure Fruit Borer Pheromone Trap', type: 'organic', brand: 'PCI Phero Lures', price: '₹120 – ₹180 / trap', query: 'Helicoverpa pheromone trap lure' }
        ]
      }
    ]
  },
    ...
    diseases: [
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Chlorothalonil 75 WP', type: 'chemical', brand: 'Kavach', price: '₹420 – ₹580 / 500g', query: 'Chlorothalonil 75 WP Kavach' }
        ]
      },
      {
        ...
        products: [
          { name: 'Pencycuron 250 SC', type: 'chemical', brand: 'Monceren (Bayer)', price: '₹420 – ₹580 / 250mL', query: 'Pencycuron 250 SC Monceren' },
      ...
      },
      {
        ...
        products: [
          { name: 'Streptocycline Bactericide', type: 'chemical', brand: 'Hindustan Antibiotics', price: '₹45 – ₹70 / 6g', query: 'Streptocycline 6g' },
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Thiamethoxam 25 WG', type: 'chemical', brand: 'Actara', price: '₹220 – ₹340 / 100g', query: 'Thiamethoxam 25 WG Actara' }
        ]
      }
    ]
  },
    ...
    diseases: [
      {
        ...
        products: [
          ...
          { name: 'Difenoconazole 25 EC', type: 'chemical', brand: 'Score (Syngenta)', price: '₹450 – ₹650 / 100mL', query: 'Difenoconazole 25 EC Score' },
          { name: 'Agricultural Spray Adjuvant (Sticker)', type: 'organic', brand: 'Apsa-80 / Wetcit', price: '₹220 – ₹320 / 500mL', query: 'Agricultural spray adjuvant sticker' }
        ]
      },
      {
        ...
        products: [
          { name: 'Carbendazim 50 WP', type: 'chemical', brand: 'Bavistin', price: '₹190 – ₹280 / 250g', query: 'Carbendazim 50 WP' },
          { name: 'Thiophanate-methyl 70 WP', type: 'chemical', brand: 'Roko', price: '₹480 – ₹690 / 500g', query: 'Thiophanate-methyl 70 WP Roko' },
      ...
      },
      {
        ...
        products: [
          { name: 'Azoxystrobin + Difenoconazole (Amistar Top)', type: 'chemical', brand: 'Amistar Top (Syngenta)', price: '₹850 – ₹1,200 / 200mL', query: 'Azoxystrobin Difenoconazole Amistar Top' },
          { name: 'Mancozeb 75 WP', type: 'chemical', brand: 'Indofil M-45', price: '₹240 – ₹350 / 500g', query: 'Mancozeb 75 WP' }
        ]
      },
      {
        ...
        products: [
          { name: 'Metalaxyl 8% + Mancozeb 64% WP', type: 'chemical', brand: 'Ridomil Gold', price: '₹480 – ₹680 / 500g', query: 'Metalaxyl Mancozeb 72 WP' },
          { name: 'Sticker Adjuvant for Onion', type: 'organic', brand: 'Agro Sticker', price: '₹220 – ₹320 / 500mL', query: 'Agricultural spray adjuvant sticker' }
        ]
      },
      {
        ...
        products: [
          { name: 'Fipronil 5 SC', type: 'chemical', brand: 'Regent (Bayer)', price: '₹380 – ₹550 / 250mL', query: 'Fipronil 5 SC Regent' },
          { name: 'Blue Sticky Traps for Thrips', type: 'organic', brand: 'Agri Blue Pads', price: '₹240 – ₹350 / pack of 10', query: 'Blue sticky traps thrips' }
        ]
      }
    ]
  },
    ...
    diseases: [
      {
        ...
        products: [
          { name: 'Spiromesifen 22.9 SC', type: 'chemical', brand: 'Oberon (Bayer)', price: '₹550 – ₹780 / 100mL', query: 'Spiromesifen Oberon Bayer' },
          { name: 'Spinetoram 11.7 SC', type: 'chemical', brand: 'Delegate (Corteva)', price: '₹950 – ₹1,350 / 100mL', query: 'Spinetoram 11.7 SC Delegate' },
          { name: 'Blue & Yellow Sticky Traps Combo', type: 'organic', brand: 'Agri Sticky Pads', price: '₹320 – ₹450 / pack of 20', query: 'Sticky traps agriculture combo' }
        ]
      },
      {
        ...
        products: [
          { name: 'Azoxystrobin 23 SC', type: 'chemical', brand: 'Amistar (Syngenta)', price: '₹750 – ₹1,050 / 200mL', query: 'Azoxystrobin 23 SC Amistar' },
          { name: 'Difenoconazole 25 EC', type: 'chemical', brand: 'Score (Syngenta)', price: '₹450 – ₹650 / 100mL', query: 'Difenoconazole 25 EC Score' }
        ]
      },
      {
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Streptocycline 6g Pouch', type: 'chemical', brand: 'Hindustan Antibiotics', price: '₹45 – ₹70 / 6g', query: 'Streptocycline 6g' }
        ]
      },
      {
    ...
    diseases: [
      {
        ...
        products: [
          ...
          { name: 'Tissue Culture Banana G9 Plants', type: 'organic', brand: 'Horticulture Lab Certified', price: '₹15 – ₹25 / sapling', query: 'Grand naine tissue culture banana plant' }
        ]
      },
      {
        ...
        products: [
          ...
          { name: 'Mineral Oil for Sigatoka (Banole)', type: 'chemical', brand: 'Banole / Agri Oil', price: '₹320 – ₹480 / 1L', query: 'Banole mineral oil banana spray' }
        ]
      },
      {
        ...
        products: [
          { name: 'Imidacloprid 17.8 SL', type: 'chemical', brand: 'Confidor', price: '₹240 – ₹380 / 100mL', query: 'Imidacloprid 17.8 SL' },
          { name: '2,4-D Sodium Salt 80% WP (Herbicide)', type: 'chemical', brand: 'Weedmar / Fernoxone', price: '₹220 – ₹320 / 500g', query: '2 4 D weedicide agriculture' }
        ]
      },
      {
        ...
        products: [
          { name: 'Chlorpyrifos 20 EC', type: 'chemical', brand: 'Dursban', price: '₹260 – ₹380 / 1L', query: 'Chlorpyrifos 20 EC' },
          { name: 'Beauveria bassiana 1% WP', type: 'organic', brand: 'Bio-Insecticide', price: '₹180 – ₹260 / 1kg', query: 'Beauveria bassiana 1kg' }
        ]
      },
      {
        ...
        products: [
          { name: 'Carbendazim 50 WP', type: 'chemical', brand: 'Bavistin', price: '₹190 – ₹280 / 250g', query: 'Carbendazim 50 WP' },
          { name: 'Banana Bunch Sleeves (UV Protected)', type: 'organic', brand: 'Agro Covers', price: '₹380 – ₹550 / 50 covers', query: 'Banana bunch cover bags' }
        ]
      }
    ]
  },
  ...
  // ── 7. MANGO ──
  {
    ...
    diseases: [
      ...
      },
      {
        ...
        products: [
          { name: 'Copper Oxychloride 50 WP', type: 'chemical', brand: 'Blitox', price: '₹280 – ₹420 / 500g', query: 'Copper Oxychloride 50 WP' },
          { name: 'Azoxystrobin 23 SC', type: 'chemical', brand: 'Amistar', price: '₹750 – ₹1,050 / 200mL', query: 'Azoxystrobin 23 SC Amistar' }
        ]
      },
      {
      ...
      },
      {
        ...
        products: [
          { name: 'Methyl Eugenol Fruit Fly Trap', type: 'organic', brand: 'Agri Phero Traps', price: '₹140 – ₹220 / unit', query: 'Methyl eugenol fruit fly trap' },
          { name: 'Malathion 50 EC', type: 'chemical', brand: 'Agri Malathion', price: '₹280 – ₹420 / 1L', query: 'Malathion 50 EC' }
        ]
      },
      {
        ...
        products: [
          { name: 'Planofix (NAA 4.5% SL)', type: 'chemical', brand: 'Bayer Planofix', price: '₹140 – ₹220 / 100mL', query: 'Planofix Bayer NAA' },
          { name: 'Carbendazim 50 WP', type: 'chemical', brand: 'Bavistin', price: '₹190 – ₹280 / 250g', query: 'Carbendazim 50 WP' }
        ]
      }
    ]
    ...
    diseases: [
      {
        ...
        products: [
          { name: 'Streptocycline 6g Pouch', type: 'chemical', brand: 'Hindustan Antibiotics', price: '₹45 – ₹70 / 6g', query: 'Streptocycline 6g' },
          { name: 'Bronopol (Bactronol)', type: 'chemical', brand: 'Bactronol / Agri Bio', price: '₹350 – ₹490 / 100g', query: 'Bronopol bactericide agriculture' },
          { name: 'Copper Oxychloride 50 WP', type: 'chemical', brand: 'Blitox', price: '₹280 – ₹420 / 500g', query: 'Copper Oxychloride 50 WP' }
        ]
      },
      {
        ...
        products: [
          { name: 'Propiconazole 25 EC (Tilt)', type: 'chemical', brand: 'Tilt / Result', price: '₹420 – ₹600 / 250mL', query: 'Propiconazole 25 EC Tilt' },
          { name: 'Chlorpyrifos 20 EC', type: 'chemical', brand: 'Dursban', price: '₹260 – ₹380 / 1L', query: 'Chlorpyrifos 20 EC' },
      ...
      },
      {
        ...
        products: [
          { name: 'Chlorantraniliprole 18.5 SC (Coragen)', type: 'chemical', brand: 'FMC Coragen', price: '₹850 – ₹1,150 / 60mL', query: 'Chlorantraniliprole 18.5 SC' },
          { name: 'Pomegranate Fruit Protection Bags', type: 'organic', brand: 'Agro Protect Bags', price: '₹350 – ₹480 / 100 bags', query: 'Pomegranate fruit protection bags' }
        ]
      },
      {
        ...
        products: [
          { name: 'Azoxystrobin 23 SC (Amistar)', type: 'chemical', brand: 'Syngenta Amistar', price: '₹750 – ₹1,050 / 200mL', query: 'Azoxystrobin 23 SC Amistar' },
          { name: 'Mancozeb 75 WP', type: 'chemical', brand: 'Dithane M-45', price: '₹240 – ₹350 / 500g', query: 'Mancozeb 75 WP' }
        ]
      },
      {
