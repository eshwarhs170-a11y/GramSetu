    ...
    diseases: [
      {
        ...
        products: [
          ...
          { name: 'Agricultural Gypsum (Calcium + Sulphur)', type: 'fertilizer', brand: 'Agri Gypsum 50kg', price: '₹320 – ₹450 / 50kg', query: 'Agricultural gypsum fertilizer 50kg' }
        ]
      },
      {
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Blue Sticky Traps', type: 'organic', brand: 'Agri Blue Pads', price: '₹240 – ₹350 / pack of 10', query: 'Blue sticky traps thrips' }
        ]
      }
    ]
  },
    ...
    diseases: [
      {
        ...
        products: [
          { name: 'Mancozeb 75 WP', type: 'chemical', brand: 'Indofil M-45', price: '₹240 – ₹350 / 500g', query: 'Mancozeb 75 WP' },
          { name: 'Propiconazole 25 EC', type: 'chemical', brand: 'Tilt', price: '₹420 – ₹600 / 250mL', query: 'Propiconazole 25 EC Tilt' }
        ]
      },
      {
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Solubor Boron 20%', type: 'fertilizer', brand: 'Multiplex Boron', price: '₹220 – ₹320 / 500g', query: 'Solubor Boron 20 agriculture' }
        ]
      },
      {
  ...
  // ── 3. SOYBEAN ──
  {
    ...
    diseases: [
      ...
      },
      {
        ...
        products: [
          { name: 'Thiamethoxam 30 FS (Seed Treatment)', type: 'chemical', brand: 'Cruiser (Syngenta)', price: '₹420 – ₹580 / 100mL', query: 'Thiamethoxam 30 FS Cruiser' },
          { name: 'Beta-cyfluthrin + Imidacloprid (Solomon)', type: 'chemical', brand: 'Solomon (Bayer)', price: '₹480 – ₹680 / 100mL', query: 'Solomon Bayer insecticide' }
        ]
      },
      {
        ...
        products: [
          { name: 'Carboxin + Thiram (Vitavax Power)', type: 'chemical', brand: 'Vitavax Power', price: '₹420 – ₹580 / 500g', query: 'Carboxin Thiram Vitavax Power' },
          { name: 'Trichoderma viride 1% WP', type: 'organic', brand: 'Bio-Fungicide', price: '₹160 – ₹230 / 1kg', query: 'Trichoderma viride 1kg' }
        ]
      },
      {
        ...
        products: [
          { name: 'Mancozeb 75 WP', type: 'chemical', brand: 'Indofil M-45', price: '₹240 – ₹350 / 500g', query: 'Mancozeb 75 WP' },
          { name: 'Azoxystrobin + Difenoconazole (Amistar Top)', type: 'chemical', brand: 'Syngenta Amistar Top', price: '₹850 – ₹1,200 / 200mL', query: 'Azoxystrobin Difenoconazole Amistar Top' }
        ]
      },
      {
        ...
        products: [
          { name: 'Chlorantraniliprole 18.5 SC', type: 'chemical', brand: 'Coragen (FMC)', price: '₹850 – ₹1,150 / 60mL', query: 'Chlorantraniliprole 18.5 SC' },
          { name: 'Profenofos 50 EC', type: 'chemical', brand: 'Curacron', price: '₹480 – ₹680 / 500mL', query: 'Profenofos 50 EC' }
        ]
      }
    ]
  },
    ...
    diseases: [
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Helilure Pheromone Trap', type: 'organic', brand: 'PCI Phero Lure', price: '₹120 – ₹180 / trap', query: 'Helicoverpa pheromone trap lure' }
        ]
      },
      {
        ...
        products: [
          { name: 'Captan 50 WP', type: 'chemical', brand: 'Captaf', price: '₹320 – ₹450 / 500g', query: 'Captan 50 WP' },
    ...
    diseases: [
      {
        ...
        products: [
          ...
          { name: 'Imidacloprid 70 WS (Seed Treatment)', type: 'chemical', brand: 'Gaucho (Bayer)', price: '₹350 – ₹490 / 100g', query: 'Imidacloprid 70 WS Gaucho' },
          { name: 'Yellow Sticky Traps', type: 'organic', brand: 'Agri Sticky Pads', price: '₹220 – ₹320 / pack of 10', query: 'Yellow sticky traps agriculture' }
        ]
      },
      {
